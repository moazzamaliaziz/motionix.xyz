...
export const tools: Tool[] = [
  ...
  // ============================================================
  {
    ...
    faqs: [
      ...
      { q: "Can I keep the aspect ratio?", a: "Yes — pick Contain to letterbox inside your target box, or Cover to fill it and crop the overflow. Fill stretches to the exact dimensions if you really need them." },
      { q: "Does it change the DPI of my photo?", a: "The inches-at-DPI mode sets the right pixel dimensions for a print size. The DPI number itself isn&apos;t written into the file — your print software reads physical size from the pixel count." },
  ...
  // ============================================================
  {
    ...
    faqs: [
      ...
      { q: "Which format should I pick?", a: "WebP gives the smallest files for the web and keeps transparency. Keep JPG for photos going into email or older software; keep PNG when you need lossless transparency." },
      { q: "Does compressing a PNG keep transparency?", a: "Yes — the PNG path preserves the alpha channel. If you convert to JPG, transparent areas are filled with white, since JPG has no transparency." },
  ...
  // ============================================================
  {
    ...
    description:
      "Drop an image and convert it to PNG, JPG, or WebP. Runs entirely on your device, so the file never leaves your tab.",
    longDescription:
      "The everyday format swap: a screenshot saved as PNG that you need as a smaller JPG, a photo you want as WebP for a fast-loading site, or a WebP someone sent you that an older app refuses to open. This converter re-encodes the image directly in your browser using the canvas API — no upload, no queue, no account. Pick the output format, choose a quality for lossy formats, and download. When you convert something with transparency (a PNG or WebP) into JPG, transparent areas are flattened onto a white background you can change, since JPG has no alpha channel.",
    useCases: [
      { title: "PNG to JPG", description: "Turn a heavy screenshot or export into a lightweight JPG for email or forms." },
      { title: "Anything to WebP", description: "Convert photos to WebP for faster-loading websites without a build step." },
      { title: "WebP to PNG/JPG", description: "Open a WebP that an older app or editor won't accept by converting it back." },
      { title: "Transparent to flat", description: "Flatten a transparent PNG onto a solid background when a service needs JPG." },
    ],
    ...
    phase: "functional",
    steps: [
      { n: "01", t: "Drop your image", d: "Drag a PNG, JPG, or WebP up to 10 MB into the viewfinder — or paste from the clipboard." },
      { n: "02", t: "Pick a format", d: "Choose PNG, JPG, or WebP. For JPG and WebP you can set a quality; PNG stays lossless." },
      { n: "03", t: "Download", d: "Convert and save. The image is re-encoded on your device and never uploaded." },
    ],
    next: ["image-compressor", "photo-resizer", "background-remover"],
    ogImage: "image-converter-og.png",
    metaTitle: "Free Image Converter — PNG, JPG, WebP in your browser (Motionix)",
    metaDescription:
      "Convert images between PNG, JPG, and WebP in your browser. No upload, no account, no tracking. Runs entirely on your device.",
    faqs: [
      { q: "Is it really free with no upload?", a: "Yes. The conversion runs in your browser via the canvas API — the image bytes never touch a server, and there's no account or watermark." },
      { q: "What happens to transparency when I convert to JPG?", a: "JPG has no alpha channel, so transparent areas are filled with a background color (white by default, which you can change) before encoding." },
      { q: "Which format should I choose?", a: "WebP for the smallest web-friendly files with transparency, JPG for photos going into email or older software, and PNG when you need lossless quality or transparency." },
      { q: "Does converting reduce quality?", a: "PNG output is lossless. JPG and WebP are lossy — we default to a high quality (0.92) and let you lower it if you want a smaller file." },
      { q: "How big can the image be?", a: "Up to 10 MB for now. Very large images are handled in-browser, so extremely large files depend on your device's memory." },
      { q: "Can it convert HEIC or RAW files?", a: "Not yet — most browsers can't decode HEIC or camera RAW in the canvas. Convert those with your OS first, then use this for PNG/JPG/WebP." },
    ],
  },
