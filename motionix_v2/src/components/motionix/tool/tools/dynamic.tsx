...
const DynamicImageConverter = dynamic(
  async () => (await import("./ImageConverterImpl")).ImageConverterImpl as unknown as React.ComponentType<unknown>,
  { ssr: false, loading: () => <Skeleton label="Loading the converter…" /> } as never,
);

export { DynamicBackgroundRemover, DynamicPassportMaker, DynamicSignatureMaker, DynamicPhotoResizer, DynamicImageCompressor, DynamicStudentIdPhotoMaker, DynamicResumePhotoMaker, DynamicVideoCompressor, DynamicImageConverter };
