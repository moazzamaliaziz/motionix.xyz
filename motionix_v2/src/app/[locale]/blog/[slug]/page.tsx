...
import { AdSlot } from "@/components/motionix/ads/AdSlot";
...
export default async function BlogPostPage({
  ...
  const breadcrumbLd = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Motionix", item: TOOLS_SITE_URL },
      { "@type": "ListItem", position: 2, name: "Blog", item: `${TOOLS_SITE_URL}/blog` },
      { "@type": "ListItem", position: 3, name: fm.title, item: `${TOOLS_SITE_URL}/blog/${post.slug}` },
    ],
  };
    ...
    <div data-mode="tool" className="min-h-screen flex flex-col bg-cream text-ink">
      ...
      <main className="flex-1 pt-32 md:pt-40 px-6 pb-24">
        <article className="max-w-2xl mx-auto">
          ...
          <AdSlot slot="blog-article-footer" className="mt-8" minHeight={280} />
