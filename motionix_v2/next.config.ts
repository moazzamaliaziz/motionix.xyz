        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              // Google AdSense/GPT origins are allowed so ad units can load on
              // marketing/blog surfaces. They stay dormant until an AdSense
              // client id is configured (see AdSlot / AdsenseScript).
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.img.ly https://staticimgly.com https://pagead2.googlesyndication.com https://partner.googleadservices.com https://tpc.googlesyndication.com",
              "worker-src 'self' blob:",
              "img-src 'self' data: blob: https:",
              "media-src 'self' blob:",
              "font-src 'self' data: https://fonts.gstatic.com",
              "style-src 'self' 'unsafe-inline'",
              "connect-src 'self' blob: https://cdn.img.ly https://staticimgly.com https://*.r2.cloudflarestorage.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net",
              // Ad iframes render inside these frames.
