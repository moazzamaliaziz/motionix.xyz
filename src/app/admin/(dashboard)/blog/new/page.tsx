  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-[24px] font-bold tracking-tight text-[var(--a-text-1)]">New Blog Post</h1>
          <p className="mt-1 text-[13px] text-[var(--a-text-3)]">Create a new blog post.</p>
        </div>
        <button
          onClick={() => router.back()}
