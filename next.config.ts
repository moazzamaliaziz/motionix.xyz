        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.img.ly https://staticimgly.com https://analytics.ahrefs.com",
              "worker-src 'self' blob:",
              "img-src 'self' data: blob: https:",
              "media-src 'self' blob:",
              "font-src 'self' data: https://fonts.gstatic.com",
              "style-src 'self' 'unsafe-inline'",
              "connect-src 'self' blob: https://cdn.img.ly https://staticimgly.com https://*.r2.cloudflarestorage.com https://analytics.ahrefs.com",
              "frame-ancestors 'self'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join("; "),
